...
int main(int argc, char *argv[])
{
	...
	std::string cfg_file = "darknet/cfg/yolov3_416.cfg";
    std::string weights_file = "darknet/yolov3.weights";
	std::string cfg_file1 = "darknet/cfg/yolov3_416.cfg";
	...
	detectors[1] = new Detector(cfg_file,weights_file);
    //detector = detector2;
    	
	for(int i=0; i<100; ++i){
		result_vec = detectors[1]->detect(image3);
	}
